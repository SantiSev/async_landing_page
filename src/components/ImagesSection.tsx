...
const ImagesSection: React.FC<ImagesSectionProps> = ({ language }) => {
    ...
    return (
        <>
            ...
            <div id="services" className='flex flex-col gap-4 items-center justify-center h-screen'>

                <div className="w-full flex justify-center items-center scale-125 mb-5">
                ...
                <div className="w-full mt-5">
                    <div className='px-24 flex justify-center items-center text-center'>
                        {texts.services_text.map((service_text, index) => (
                            <div
                                key={index}
                                className={`justify-center scale-90 items-center flex flex-col w-1/3 h-fit rounded-full bg-opacity-30 text-white font-montserrat hover:scale-90 transform transition-all ease-in duration-150`}
                            >
