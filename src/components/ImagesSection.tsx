          ...
          <div className="w-full ">
            <div className="flex justify-center items-center text-center -mt-2 mb-5">
              {texts.services_text.map((service, index) => (
                <div
                  key={index}
                  className={`-mt-64 md:-mt-56 justify-center items-center flex flex-col xl:w-1/3 w-full h-fit rounded-full bg-opacity-30 text-white font-montserrat cursor-pointer transition-opacity duration-1000 ${
