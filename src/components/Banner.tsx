  ...
  return (
    <>
      <div className=" w-fit h-screen">
        ...
        <div className="flex items-center justify-center absolute bottom-0 left-0 w-full h-1/6 bg-gradient-to-b from-transparent via-transparent  to-background_blue opacity-25 hover:opacity-100 transition transform">
